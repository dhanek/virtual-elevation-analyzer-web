...
**Linked to PIPE-02 (Consistent render/update behavior) — Phase 1 only documented the divergence, did not fix it.**
...
**Proposed as Phase 7** — awaiting roadmap addition.
