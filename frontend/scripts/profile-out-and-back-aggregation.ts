...
} from '../src/shell/outAndBack/outAndBackPlots'
...
function makeInputs(sectionCount: number, samplesPerLeg: number, withCompare: boolean) {
...
function main(): void {
    ...
    out('  Roughly equal ratios mean the per-section cost is flat in the SECTION')
