...
import type { ActivityDataLike, ActivityLapLike, AppState, LapIndexRange } from '../../state/AppState';
...
export type AnalysisSelectionEntry = ActivityLapLike | DetectedLap | OutAndBackSection;
