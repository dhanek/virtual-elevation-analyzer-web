/**
 * `plotly.js-cartesian-dist` ships a prebuilt bundle with no type declarations, and
 * the DefinitelyTyped package for it describes the full build rather than the cartesian partial bundle.
 *
