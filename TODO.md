...
*Restricting the feature to the 82-day window looks poor: the `.fit` files in the local download folder carry
...
- [x] **[S] A FIT file with exactly one lap ticks that lap by default, in all three modes.**
      ...
      - [x] **MANUAL, RUN 2026-09-02 at `d586961`:** confirmed in the running app by the maintainer,
            ...
            and on the reference ride. All five steps passed. **(a)** lap 1 ticked with no
            ...
            **(b)** switching to "GPS based out and back" ran detection off that selection without
            ...
            list; **(d)** the reference ride came up with nothing ticked and ran no detection
